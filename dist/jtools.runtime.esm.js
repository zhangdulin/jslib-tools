 ...
 * @Date: 2021-06-08 11:30:40
 * @LastEditors: zhangyu
 * @LastEditTime: 2021-06-10 17:59:37
 * @Description: 
 */
 ...
 * @Description: 
 */
var utf16toEntities$1 = require("../.internal/utf16toEntities");

var entitiestoUtf16$1 = require("../.internal/entitiestoUtf16");
/**
...
function handleText() {
  ...
  if (type === "encode") {
    newStr = entitiestoUtf16$1(str).replace(/<br>/gi, "\n").replace(/&nbsp;/g, " ").replace("&lt;", "<").replace("&gt;", ">");
  } else if (type === "decode") {
    newStr = utf16toEntities$1(str).replace("<", "&lt;").replace(">", "&gt;").replace(/\n|\r\n/g, "<br>").replace(/[ ]/g, "&nbsp;");
  } else {
    return str;
  }
